...
for patch, c in zip(bp["boxes"], colors_box):
    ...
    patch.set_alpha(0.7)
ax_nps.set_title(
    f"NPS by churn month  ·  M2 detractor rate {detractor_ratio:.1f}× retained",
...
ax_feat.set_title(
    "Churn drivers  ·  LogReg coefficients",
    fontsize=10, loc="left", pad=12,
)
...
ax_chan.set_title("12-month LTV by acquisition channel", fontsize=10, loc="left", pad=12)
